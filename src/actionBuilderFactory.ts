...
export const actionBuilderFactory = <State, RootState, NamespaceArgs = unknown>(
  ...
  return {
    generate: <Payload, ReturnValue = unknown>(
      ...
      const enhancedAction = actionBuilder<Payload, State, RootState, ReturnValue, NamespaceArgs>(
        type,
        actionHandler,
        options
      )
